...
static ClioConfigDefinition ClioConfig = ClioConfigDefinition{
    {{"database.type", ConfigValue{ConfigType::String}.defaultValue("cassandra").withConstraint(nameCassandra)},
     ...
     {"database.cassandra.core_connections_per_host",
      ConfigValue{ConfigType::Integer}.defaultValue(1).withConstraint(ValidUint16)},
     {"database.cassandra.queue_size_io", ConfigValue{ConfigType::Integer}.optional().withConstraint(ValidUint16)},
     {"database.cassandra.write_batch_size",
      ConfigValue{ConfigType::Integer}.defaultValue(20).withConstraint(ValidUint16)},
     ...
     {"dos_guard.max_fetches", ConfigValue{ConfigType::Integer}.defaultValue(1000'000).withConstraint(ValidUint32)},
     {"dos_guard.max_connections", ConfigValue{ConfigType::Integer}.defaultValue(20).withConstraint(ValidUint32)},
     {"dos_guard.max_requests", ConfigValue{ConfigType::Integer}.defaultValue(20).withConstraint(ValidUint32)},
     ...
     {"server.workers", ConfigValue{ConfigType::Integer}.withConstraint(ValidUint32)},
     {"server.max_queue_size", ConfigValue{ConfigType::Integer}.defaultValue(0).withConstraint(ValidUint32)},
     {"server.local_admin", ConfigValue{ConfigType::Boolean}.optional()},
     {"server.admin_password", ConfigValue{ConfigType::String}.optional()},
     {"prometheus.enabled", ConfigValue{ConfigType::Boolean}.defaultValue(true)},
     {"prometheus.compress_reply", ConfigValue{ConfigType::Boolean}.defaultValue(true)},
     {"io_threads", ConfigValue{ConfigType::Integer}.defaultValue(2).withConstraint(ValidUint16)},
     {"cache.num_diffs", ConfigValue{ConfigType::Integer}.defaultValue(32).withConstraint(ValidUint16)},
     {"cache.num_markers", ConfigValue{ConfigType::Integer}.defaultValue(48).withConstraint(ValidUint16)},
     {"cache.num_cursors_from_diff", ConfigValue{ConfigType::Integer}.defaultValue(0).withConstraint(ValidUint16)},
     {"cache.num_cursors_from_account", ConfigValue{ConfigType::Integer}.defaultValue(0).withConstraint(ValidUint16)},
     {"cache.page_fetch_size", ConfigValue{ConfigType::Integer}.defaultValue(512).withConstraint(ValidUint16)},
     ...
     {"log_rotation_size", ConfigValue{ConfigType::Integer}.defaultValue(2048).withConstraint(ValidUint64)},
     {"log_directory_max_size", ConfigValue{ConfigType::Integer}.defaultValue(50 * 1024).withConstraint(ValidUint64)},
     {"log_rotation_hour_interval", ConfigValue{ConfigType::Integer}.defaultValue(12).withConstraint(ValidUint32)},
     {"log_tag_style", ConfigValue{ConfigType::String}.defaultValue("uint").withConstraint(logTag)},
     {"extractor_threads", ConfigValue{ConfigType::Integer}.defaultValue(2u).withConstraint(ValidUint32)},
     {"read_only", ConfigValue{ConfigType::Boolean}.defaultValue(false)},
     {"txn_threshold", ConfigValue{ConfigType::Integer}.defaultValue(0).withConstraint(ValidUint16)},
     {"start_sequence", ConfigValue{ConfigType::Integer}.optional().withConstraint(ValidUint32)},
     {"finish_sequence", ConfigValue{ConfigType::Integer}.optional().withConstraint(ValidUint32)},
