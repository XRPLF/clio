...
public:
    ...
    spec([[maybe_unused]] uint32_t apiVersion)
    {
        static auto const kRPC_SPEC = RpcSpec{
             ...
             meta::Section{
                 {JS(currency),
                  ...
                  meta::WithCustomError{
                      validation::CustomValidators::currencyValidator, Status(RippledError::RpcDstAmtMalformed)
                  }},
                 {JS(issuer),
                  meta::WithCustomError{
                      validation::CustomValidators::issuerValidator, Status(RippledError::RpcDstIsrMalformed)
                  }}
             }},
            {JS(taker_pays),
             validation::Required{},
             ...
             meta::Section{
                 {JS(currency),
                  validation::Required{},
                  meta::WithCustomError{
                      validation::CustomValidators::currencyValidator, Status(RippledError::RpcSrcCurMalformed)
                  }},
                 {JS(issuer),
                  meta::WithCustomError{
                      validation::CustomValidators::issuerValidator, Status(RippledError::RpcSrcIsrMalformed)
                  }}
             }},
            ...
            {JS(domain),
             meta::WithCustomError{
                 validation::Type<std::string>{}, Status(RippledError::RpcDomainMalformed, "Unable to parse domain.")
             },
             meta::WithCustomError{
