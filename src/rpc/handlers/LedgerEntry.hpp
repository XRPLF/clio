    ...
    spec([[maybe_unused]] uint32_t apiVersion)
    {
        ...
        static auto const kBRIDGE_JSON_VALIDATOR = meta::WithCustomError{
            meta::IfType<boost::json::object>{meta::Section{
                {xrpl::sfLockingChainDoor.getJsonName().c_str(),
                 validation::Required{},
                 validation::CustomValidators::accountBase58Validator},
                {xrpl::sfIssuingChainDoor.getJsonName().c_str(),
                 validation::Required{},
                 validation::CustomValidators::accountBase58Validator},
                {xrpl::sfLockingChainIssue.getJsonName().c_str(),
                 validation::Required{},
                 validation::CustomValidators::currencyIssueValidator},
                {xrpl::sfIssuingChainIssue.getJsonName().c_str(),
                 validation::Required{},
                 validation::CustomValidators::currencyIssueValidator},
            }},
            Status(ClioError::RpcMalformedRequest)
