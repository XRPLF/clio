...
handledRpcs()
{
    static std::unordered_set<std::string_view> const kHANDLED_RPCS = {
        ...
        "amm_info",         "book_changes",       "book_offers",         "deposit_authorized",
        "feature",          "gateway_balances",   "get_aggregate_price", "ledger",
        "ledger_data",      "ledger_entry",       "ledger_index",        "ledger_range",
        "mpt_holders",      "nfts_by_issuer",     "nft_history",         "nft_buy_offers",
        "nft_info",         "nft_sell_offers",    "noripple_check",      "ping",
        "random",           "server_info",        "transaction_entry",   "tx",
        "subscribe",        "unsubscribe",        "vault_info",          "version",
    };
