 ...
 */
template <SomeSettingsProvider SettingsProviderType>
class KeyspaceSchema : public AbstractSchema<SettingsProviderType> {
...
public:
    ...
    PreparedStatement const&
    insertLedgerRange() const
    {
        return statements_->insertLedgerRange;
    }
    PreparedStatement const&
    ...
    PreparedStatement const&
    selectNFTsAfterTaxonKeyspaces() const
    {
        return statements_->selectNFTsAfterTaxonKeyspaces;
    }
    PreparedStatement const&
