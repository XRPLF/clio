...
public:
     ...
     */
    virtual void
    subTransactions(SubscriberSharedPtr const& subscriber, std::uint32_t apiVersion) = 0;
     ...
     */
    virtual void
    subAccount(ripple::AccountID const& account, SubscriberSharedPtr const& subscriber, std::uint32_t apiVersion) = 0;
     ...
     */
    virtual void
    subBook(ripple::Book const& book, SubscriberSharedPtr const& subscriber, std::uint32_t apiVersion) = 0;
