...
struct BookChangesFeed : public SingleFeedBase<ExecutionContext> {
    BookChangesFeed(ExecutionContext& executorContext)
        : SingleFeedBase<ExecutionContext>(executorContext, "book_changes")
    {
    }
    ...
    {
        SingleFeedBase<ExecutionContext>::pub(boost::json::serialize(rpc::computeBookChanges(lgrInfo, transactions)));
    }
};
}  // namespace feed::impl
