...
using AllBackends = ::testing::Types<cfgMOCK, cfgCASSANDRA, cfgPOSTGRES>;
...
public:
    ...
    MOCK_METHOD(NetworkValidatedLedgers&, ledgers, (), (const, override));
    MOCK_METHOD(DOSGuard&, dosGuard, (), (const, override));
    MOCK_METHOD(ReportingETL&, reporting, (), (const, override));
    MOCK_METHOD(RPC::WorkQueue&, workers, (), (const, override));
