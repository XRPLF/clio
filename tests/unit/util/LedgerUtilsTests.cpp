...
TEST(LedgerUtilsTests, DeletionBlockerTypes)
{
    ...
    static constexpr xrpl::LedgerEntryType kDELETION_BLOCKERS[] = {
        xrpl::ltCHECK,
        xrpl::ltESCROW,
        xrpl::ltNFTOKEN_PAGE,
        xrpl::ltPAYCHAN,
...
static LedgerEntryTypeParam const kACCOUNT_OWNED_TEST_CASES[] = {
    ...
    {.input = "xchain_owned_create_account_claim_id", .expected = xrpl::ltXCHAIN_OWNED_CREATE_ACCOUNT_CLAIM_ID},
    ...
    {.input = "XChainOwnedCreateAccountClaimID", .expected = xrpl::ltXCHAIN_OWNED_CREATE_ACCOUNT_CLAIM_ID},
    {.input = "DID", .expected = xrpl::ltDID},
    {.input = "Oracle", .expected = xrpl::ltORACLE},
    {.input = "Credential", .expected = xrpl::ltCREDENTIAL},
