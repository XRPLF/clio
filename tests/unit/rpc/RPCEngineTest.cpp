...
class RPCEngineTest : public MockBackendTest, MockCountersTest, MockLoadBalancerTest {
protected:
    ...
    std::shared_ptr<RPCEngine> engine =
        make_RPCEngine(cfg, backend, mockLoadBalancerPtr, dosGuard, queue, *mockCountersPtr, handlerProvider);
};
